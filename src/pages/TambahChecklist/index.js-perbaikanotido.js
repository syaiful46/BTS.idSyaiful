...
const KetidakhadiranAjukanPage = ({navigation, route}) => {
  ...
  const [flexibel, setFlexibel] = useState('');
  ...
  const getListCuti = async () => {
    try {
      ...
      if (value !== null) {
        ...
        setFlexibel(text.data.flexible);
    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <ScrollView>
        ...
        <View
          ...
          <Text style={styles.textButtonH}>PENGAJUAN CUTI</Text>
        </View>
          ...
          <DropDownPicker
            ...
            onChangeValue={() =>
              value === 'Cuti'
                ...
                : navigation.navigate('KetidakhadiranAjukanPageLibur', {
                    users: route.params.users,
                  })
            }
          />
