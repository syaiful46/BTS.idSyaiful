    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      <View style={styles.headers}>
        <TouchableOpacity
          onPress={() =>
            navigation.navigate(
              route.params.users === 'kdc' ? 'MainAppKDC' : 
          ...
          <Image
            source={
              route.params.users === 'korsn' || route.params.users === 'usersn' || route.params.users === 'kdc'
                ? PrevOrange
                : Prev
            }
      ...
      <ScrollView>
        <View style={{alignItems: 'center'}}>
          ...
          <Text style={styles.judulHeadline2beda}>{alamats}</Text>
        </View>
        <View
          style={{
          ...
          <Text style={styles.judulHeadline3}>Lokasi</Text>
            ...
            <Text style={styles.judulHeadline4}>{start_contracts}</Text>
            <Text style={styles.judulHeadline3}>End Contract</Text>
            <Text style={styles.judulHeadline4}>{end_contracts}</Text>
            ...
            <Text style={styles.judulHeadline4}>0{phones}</Text>
          </View>
        </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            style={
              route.params.users === 'usersn' || route.params.users === 'korsn' || route.params.users === 'kdc'
                ? styles.btnSectionOrange
                : styles.btnSection
            }>
